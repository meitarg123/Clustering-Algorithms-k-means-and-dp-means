...
class KMeans:
    def __init__(self, number_of_clusters=100, max_iterations=500):
    ...
    def centroids_initiation(self,data_set):
        ...
        min_, max_ = np.min(data_set, axis=0), np.max(data_set, axis=0)
        self.centroids = [uniform(min_, max_) for _ in range(self.number_of_clusters)]
